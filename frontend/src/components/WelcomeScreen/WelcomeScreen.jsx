  ...
  const handleAuthSubmit = async (e) => {
    ...
    if (authMode === 'register') {
      if (formData.password !== formData.confirmPassword) {
        toast({
          title: translations[language].passwordMismatch || "Mật khẩu không khớp",
          status: "error",
          duration: 3000,
          isClosable: true,
        });
      ...
      try {
        ...
        toast({
          title: translations[language].registerSuccess || "Đăng ký thành công!",
          status: "success",
          duration: 3000,
          isClosable: true,
        });
        ...
        toast({
          title: translations[language].registerError || "Đăng ký thất bại",
      ...
      try {
        ...
        toast({
          title: translations[language].loginSuccess || "Đăng nhập thành công!",
          status: "success",
          duration: 3000,
          isClosable: true,
        });
        ...
        toast({
          title: translations[language].loginError || "Đăng nhập thất bại",
          description: error.message,
          status: "error",
          duration: 3000,
          isClosable: true,
